    ...
    <div class="container-fluid" style="margin-top: 100px;">
        <div class="row justify-content-center">
            <div class="col">
                ...
                <!-- modificación de tipo de auto -->
                <div class="card">
                    <div class="card-header">
                        Agregar nuevo tipo de auto
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        if (isset($_GET['id'])) {
                            ...
                            //trae todos los id de la tabla tipo_auto
                            $consulta = "SELECT * FROM tipo_auto WHERE id='$id'";
                            ...
                            //varibale que contiene los datos del arrays $reg 

                            $tipo_auto = $reg['tipo_auto'];
                        }
                        ?>
                        <form action="" method="post">
                            <!-- ingreso del tipo de auto -->
                            <div class="form-group">
                                <label for="exampleInputEmail1">Tipo de Auto</label>
                                <input type="text" class="form-control" name="tipo_auto" value="<?php echo $tipo_auto ?>" required>
                            </div>

                            <div class="text-right">
                                <!-- boton para modificar  -->
                                <button type="submit" name="modificar" class="btn btn-primary">Modificar</button>
                                <!-- boton para cancelar y volver al indice de tipo de auto -->
                                <a href="tipos_autos_index.php"><button type="button" class="btn btn-danger">Cancelar</button></a>
                            </div>
                        </form>
                        <?php
                        ...
                        if (isset($_POST['modificar'])) {
                            ...
                            $actualizar_tipo_auto = $_POST['tipo_auto'];

                            //actualiza los datos en la tabla autos y los configura a su nuevo valor
                            $actualizar = "UPDATE tipo_auto SET tipo_auto='$actualizar_tipo_auto' WHERE id='$id'";

                            //verifica si  existen datos en la variable  
                            $ejecutar = mysqli_query($conexion, $actualizar);
                            if ($ejecutar) {
                                //te redirecciona al index de tipo de auto
