            ...
            <div class="col">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="nombre_alta_form.php">
                            <button type="button" class="btn btn-success float-right">Agregar Nombre</button>
                        </a>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                //guarda todos los datos de la tabla nombre en la variable $registros
                                $registros = mysqli_query($conexion, "SELECT *
                          FROM nombre") or die("Problemas en el select:" . mysqli_error($conexion));
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="nombre_alta_form_edit.php?id=<?php echo $reg['id'] ?>"><button type="button" class="btn btn-info">Modificar</button></a>
                                            <!-- boton para cancelar y volver al indice de nombre -->
                                            <a href="nombre_autos_index.php?borrar=<?php echo $reg['id'] ?>"><button type="button" name="borrar" class="btn btn-danger">Eliminar</button></a>
                                        </td>
                                    </tr>
                                ...
                                if (isset($_GET['borrar'])) {
                                    ...
                                    $conexion = mysqli_connect("localhost", "root", "", "concesionario") or die("Problemas con la conexión hacia la db.");
                                    //se borra todos los datos en la tabla nombre
                                    $borrar = "DELETE FROM nombre WHERE id='$borrar_id'";
