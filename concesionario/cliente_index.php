                    ...
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                $registros = mysqli_query($conexion, "SELECT *FROM cliente") or die("Problemas en el select:" . mysqli_error($conexion));
                                ...
                                ?>
                                    ...
                                    <!-- muestra la informacion del array -->
                                        ...
                                        <td>
                                            <a href="cliente_alta_form_edit.php?id=<?php echo $reg['id'] ?>"><button type="button" class="btn btn-info">Modificar</button></a>
                                            <a href="cliente_index.php?borrar=<?php echo $reg['id'] ?>"><button type="button" name="borrar" class="btn btn-danger">Eliminar</button></a>
                                        </td>
                                    </tr>
                                ...
                                if (isset($_GET['borrar'])) {
                                    ...
                                    $conexion = mysqli_connect("localhost", "root", "", "concesionario") or die("Problemas con la conexión hacia la db.");
//se borra todos los datos en la tabla cliente
                                    $borrar = "DELETE FROM cliente WHERE id='$borrar_id'";
