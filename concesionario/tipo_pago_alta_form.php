                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        if (isset($_POST['registrar'])) {
                            ...
                            //se almacena la informacion que inserta en la tabla tipo_pago en la varibale ejecutar 
                            $ejecutar = mysqli_query($conexion, "INSERT into tipo_pago(metodo_pago) values 
                       ('$_POST[metodo_pago]')")
