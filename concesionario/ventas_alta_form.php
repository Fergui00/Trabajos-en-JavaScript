                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="post">
                            ...
                            <select class="custom-select" name="id_auto">
                                ...
                                while ($consulta_array_auto = mysqli_fetch_array($consulta_auto)) {
                                    ...
                                    echo '<option value="' . $consulta_array_auto['id'] . '">' . 'Marca: ' . $data_marca['marca'] . ' | ' . 'Tipo: ' . $data_tipo['tipo_auto'] . ' | ' . 'Modelo: ' . $data_modelo['modelo'] . ' | ' . 'Color: ' . $data_color['color'] . '</option>';
                                }
                                ?>
                            </select>
                            ...
                            <select class="custom-select" name="id_cliente">
                                <option selected disabled>Seleccione al Comprador:</option>
                                <?php
                                $conexion = mysqli_connect("localhost", "root", "", "concesionario") or die("Problemas con la conexión hacia la db.");
                        ...
                        if (isset($_POST['registrar'])) {
                            ...
                            //se almacena la informacion que inserta en la tabla ventas en la varibale ejecutar 
                            $ejecutar = mysqli_query($conexion, "INSERT INTO ventas(id_auto,id_empleado,id_cliente,fecha,id_metodo_pago,importe) values ('$_POST[id_auto]','$_POST[id_empleado]','$_POST[id_cliente]','$_POST[fecha]','$_POST[id_metodo_pago]','$_POST[importe]')") or die("Problemas en el select" . mysqli_error($conexion));
