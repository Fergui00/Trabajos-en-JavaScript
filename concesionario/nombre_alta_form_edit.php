            ...
            <div class="col">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        if (isset($_GET['id'])) {
                            $id = $_GET['id'];
                            //trae todos los id de la tabla nombre
                        ...
                        if (isset($_POST['modificar'])) {
                            ...
                            //actualiza los datos en la tabla nombre y los configura a su nuevo valor
                            $actualizar = "UPDATE nombre SET nombre='$actualizar_nombre' WHERE id='$id'";
                            //verifica si  existen datos en la variable  
