            ...
            <div class="col">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="autos_tipos_form.php">
                            <button type="button" class="btn btn-success float-right">Agregar Tipos</button>
                        </a>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table">
                          ...
                          FROM tipo_auto") or die("Problemas en el select:" . mysqli_error($conexion));
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $reg['tipo_auto']; ?></td>
                                        <td>
                                            <!-- boton para modificar  -->
                                            <a href="autos_tipos_form_edit.php?id=<?php echo $reg['id'] ?>"><button type="button" class="btn btn-info">Modificar</button></a>
                                            <!-- boton para cancelar y volver al indice de tipos de autos -->
                                            <a href="tipos_autos_index.php?borrar=<?php echo $reg['id'] ?>"><button type="button" name="borrar" class="btn btn-danger">Eliminar</button></a>
                                        </td>
                                    </tr>
                                ...
                                if (isset($_GET['borrar'])) {
                                    ...
                                    $conexion = mysqli_connect("localhost", "root", "", "concesionario") or die("Problemas con la conexión hacia la db.");
                                    //se borra todos los datos en la tabla tipo_auto
                                    $borrar = "DELETE FROM tipo_auto WHERE id='$borrar_id'";
                                    $ejecutar = mysqli_query($conexion, $borrar);
                                    //verifica si  existen datos en la variable  
                                    if ($ejecutar) {
                                        //te redirecciona al index de tipo_auto
                                        header("location:tipos_autos_index.php");
                                    }
