                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        if (isset($_POST['registrar'])) {
                            ...
                            //se almacena la informacion que inserta en la tabla cliente en la varibale ejecutar 
                            $ejecutar = mysqli_query($conexion, "INSERT into cliente(id, nombre, apellido, direccion, telefono) values 
