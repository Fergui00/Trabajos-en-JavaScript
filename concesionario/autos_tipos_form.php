                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="tipo_auto" required>
                            </div>
                        ...
                        if (isset($_POST['registrar'])) {
                            ...
                            //se almacena la informacion que inserta en la tabla tipo_auto en la varibale ejecutar 
                            $ejecutar = mysqli_query($conexion, "INSERT into tipo_auto(tipo_auto) values 
                       ('$_POST[tipo_auto]')")
