            ...
            <div class="col">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        if (isset($_GET['id'])) {
                            $id = $_GET['id'];
                            //trae todos los id de la tabla marca
                        ...
                        <form action="" method="post">
                            ...
                            <div class="text-right">
                                ...
                                <a href="marca_autos_index.php"><button type="button" class="btn btn-danger">Cancelar</button></a>
                            </div>
                        </form>
                        <?php
                        ...
                        if (isset($_POST['modificar'])) {
                            ...
                            //actualiza los datos en la tabla marca y los configura a su nuevo valor
                            $actualizar = "UPDATE marca SET marca='$actualizar_marca' WHERE id='$id'";
                            //verifica si  existen datos en la variable 
