                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        if (isset($_GET['id'])) {
                            ...
                            $consulta = "SELECT * FROM color WHERE id='$id'";
                        ...
                        if (isset($_POST['modificar'])) {
                            ...
                            //actualiza los datos en la tabla color y los configura a su nuevo valor
                            $actualizar = "UPDATE color SET color='$actualizar_color' WHERE id='$id'";

                            //verifica si  existen datos en la variable 
                            $ejecutar = mysqli_query($conexion, $actualizar);
                            if ($ejecutar) {
                                 //te redirecciona al index de colores
