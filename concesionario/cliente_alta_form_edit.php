                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nombre" value="<?php echo $nombre_cliente ?>" required>
                            </div>

                            <!-- ingreso del Apellido -->
                            <div class="form-group">
                                <label for="exampleInputEmail1">Ingrese el Apellido</label>
                                <input type="text" class="form-control" name="apellido" value="<?php echo $apellido_cliente ?>" required>
                            </div>

                            <!-- ingreso del Direccion -->
                            <div class="form-group">
                                <label for="exampleInputEmail1">Ingrese la Direccion</label>
                                <input type="text" class="form-control" name="direccion" value="<?php echo $direccion_cliente ?>" required>
                            </div>

                            <!-- ingreso del Telefono -->
                            <div class="form-group">
                                <label for="exampleInputEmail1">Ingrese el Telefono</label>
                                <input type="text" class="form-control" name="telefono" value="<?php echo $telefono_cliente ?>" required>
                            </div>

                            <div class="text-right">
                                <!-- boton para modificar  -->
                                <button type="submit" name="modificar" class="btn btn-primary">Modificar</button>
                                <!-- boton para cancelar y volver al indice de cliente  -->
                                <a href="cliente_index.php"><button type="button" class="btn btn-danger">Cancelar</button></a>
                            </div>
                        </form>
                        <?php
                        ...
                        if (isset($_POST['modificar'])) {
                            ...
                            if ($ejecutar) {
                                //te redirecciona al index de clientes
