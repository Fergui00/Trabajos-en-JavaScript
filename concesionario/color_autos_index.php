            ...
            <div class="col">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="color_alta_form.php">
                            <button type="button" class="btn btn-success float-right">Agregar Colores</button>
                        </a>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table">
                          ...
                          FROM color") or die("Problemas en el select:" . mysqli_error($conexion));
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="color_alta_form_edit.php?id=<?php echo $reg['id'] ?>"><button type="button" class="btn btn-info">Modificar</button></a>
                                            <!-- boton para cancelar y volver al indice de colores -->
                                            <a href="color_autos_index.php?borrar=<?php echo $reg['id'] ?>"><button type="button" name="borrar" class="btn btn-danger">Eliminar</button></a>
                                        </td>
                                    </tr>
...
//se borra todos los datos en la tabla autos
                                    $borrar = "DELETE FROM color WHERE id='$borrar_id'";
                                    $ejecutar = mysqli_query($conexion, $borrar);

                                    if ($ejecutar) {
                                        header("location:color_autos_index.php");
                                    }
