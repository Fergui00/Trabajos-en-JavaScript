                    ...
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                //guarda todos los datos de la tabla empleado en la variable $registros
                                $registros = mysqli_query($conexion, "SELECT *
                          FROM empleado") or die("Problemas en el select:" . mysqli_error($conexion));
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="empleado_alta_form_edit.php?id=<?php echo $reg['id'] ?>"><button type="button" class="btn btn-info">Modificar</button></a>
                                            <!-- boton para cancelar y volver al indice de empleado -->
                                            <a href="empleado_index.php?borrar=<?php echo $reg['id'] ?>"><button type="button" name="borrar" class="btn btn-danger">Eliminar</button></a>
                                        </td>
                                    </tr>
                                ...
                                if (isset($_GET['borrar'])) {
                                    ...
                                    $conexion = mysqli_connect("localhost", "root", "", "concesionario") or die("Problemas con la conexión hacia la db.");
                                    //se borra todos los datos en la tabla empleado
                                    $borrar = "DELETE FROM empleado WHERE id='$borrar_id'";
