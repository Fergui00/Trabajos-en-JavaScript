            ...
            <div class="col">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="marca_alta_form.php">
                            <button type="button" class="btn btn-success float-right">Agregar Marca</button>
                        </a>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                //guarda todos los datos de la tabla marca en la variable $registros
                                $registros = mysqli_query($conexion, "SELECT *
                          FROM marca") or die("Problemas en el select:" . mysqli_error($conexion));
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="marca_alta_form_edit.php?id=<?php echo $reg['id'] ?>"><button type="button" class="btn btn-info">Modificar</button></a>
                                            <!-- boton para cancelar y volver al indice de marca -->
                                            <a href="marca_autos_index.php?borrar=<?php echo $reg['id'] ?>"><button type="button" name="borrar" class="btn btn-danger">Eliminar</button></a>
                                        </td>
                                    </tr>
                                ...
                                if (isset($_GET['borrar'])) {
                                    ...
                                    $conexion = mysqli_connect("localhost", "root", "", "concesionario") or die("Problemas con la conexión hacia la db.");
                                    //se borra todos los datos en la tabla marca
                                    $borrar = "DELETE FROM marca WHERE id='$borrar_id'";
                                    $ejecutar = mysqli_query($conexion, $borrar);
                                    //verifica si  existen datos en la variable  
                                    if ($ejecutar) {
                                        //te redirecciona al index de marca
                                        header("location:marca_autos_index.php");
                                    }
