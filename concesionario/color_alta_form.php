                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="text-right">
                                ...
                                <a href="color_autos_index.php"><button type="button" class="btn btn-danger">Cancelar</button></a>
                            </div>
                        </form>
                        ...
                        if (isset($_POST['registrar'])) {
                            ...
                            //se almacena la informacion que inserta en la tabla color en la varibale ejecutar 
                            $ejecutar = mysqli_query($conexion, "INSERT into color(color) values 
                       ('$_POST[color]')")
                                or die("Problemas en el select" . mysqli_error($conexion));
                            //verifica si  existen datos en la variable
                            if ($ejecutar) {
                                //te redirecciona al index de color
