            ...
            <div class="col">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        if (isset($_GET['id'])) {
                            $id = $_GET['id'];
                            //trae todos los id de la tabla empleado
                            ...
                            $nombre_empleado = $reg['nombre'];
                            $apellido_empleado = $reg['apellido'];
                            $email_empleado = $reg['email'];
                            $telefono_empleado = $reg['telefono'];
                        }
                        ?>
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nombre" value="<?php echo $nombre_empleado ?>" required>
                            </div>
                            <!-- ingreso del Apellido -->
                            <div class="form-group">
                                <label for="exampleInputEmail1">Ingrese el Apellido</label>
                                <input type="text" class="form-control" name="apellido" value="<?php echo $apellido_empleado ?>" required>
                            </div>
                            <!-- ingreso del Email -->
                            <div class="form-group">
                                <label for="exampleInputEmail1">Ingrese el Email</label>
                                <input type="text" class="form-control" name="email" value="<?php echo $email_empleado ?>" required>
                            </div>
                            <!-- ingreso del Telefono -->
                            <div class="form-group">
                                <label for="exampleInputEmail1">Ingrese el Telefono</label>
                                <input type="text" class="form-control" name="telefono" value="<?php echo $telefono_empleado ?>" required>
                            </div>
                        ...
                        if (isset($_POST['modificar'])) {
                            ...
                            //actualiza los datos en la tabla empleado y los configura a su nuevo valor
                            ...
                            if ($ejecutar) {
                                ...
                                //te redirecciona al index de empleado
