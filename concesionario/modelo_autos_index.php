            ...
            <div class="col">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="modelo_alta_form.php">
                            <button type="button" class="btn btn-success float-right">Agregar Modelo</button>
                        </a>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table">
                          ...
                          FROM modelo") or die("Problemas en el select:" . mysqli_error($conexion));
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="modelo_alta_form_edit.php?id=<?php echo $reg['id'] ?>"><button type="button" class="btn btn-info">Modificar</button></a>
                                            <!-- boton para cancelar y volver al indice de modelo -->
                                            <a href="modelo_autos_index.php?borrar=<?php echo $reg['id'] ?>"><button type="button" name="borrar" class="btn btn-danger">Eliminar</button></a>
                                        </td>
                                    </tr>
                                ...
                                if (isset($_GET['borrar'])) {
                                    ...
                                    $conexion = mysqli_connect("localhost", "root", "", "concesionario") or die("Problemas con la conexión hacia la db.");
                                    //se borra todos los datos en la tabla modelo
                                    $borrar = "DELETE FROM modelo WHERE id='$borrar_id'";
